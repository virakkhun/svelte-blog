...
<div>
  <div class="relative">
    <div class="h-1 bg-white w-0 sticky top-12 z-100 bg-filter" style:width={`${barIndicator}%`}></div>
    {#if isLoading}
    ...
    <div class="grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 gap-3 w-4/5 mx-auto my-10 ">
      {#each data as d}
        <div class="flex flex-col gap-2 p-2 rounded-md bg-black/20 backdrop-blur-md border border-orange/30 hoverFilter max-h-auto">
